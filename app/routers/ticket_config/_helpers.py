...
_DEFAULTS: dict[str, dict] = {
    "general": {"display_name": "General Support", "description": "General questions and miscellaneous requests.", "emoji": "💬", "color_hex": "#5865F2", "enabled": True, "max_open_per_user": 1, "welcome_text": ""},
    "rankup": {"display_name": "Rank Up", "description": "Apply for a rank based on your OSRS achievements.", "emoji": "⬆️", "color_hex": "#f0b232", "enabled": True, "max_open_per_user": 1, "welcome_text": ""},
    "join_cc": {"display_name": "Join the CC", "description": "Apply to join the Iron Foundry clan chat.", "emoji": "🏰", "color_hex": "#57f287", "enabled": True, "max_open_per_user": 1, "welcome_text": ""},
    "contact_mentor": {"display_name": "Contact a Mentor", "description": "Get help from a mentor with Raids & PVM.", "emoji": "⚔️", "color_hex": "#9b59b6", "enabled": True, "max_open_per_user": 1, "welcome_text": ""},
    "sensitive": {"display_name": "Sensitive", "description": "For sensitive matters requiring Senior Staff or Owner attention.", "emoji": "🔒", "color_hex": "#ed4245", "enabled": True, "max_open_per_user": 1, "welcome_text": ""},
}
...
async def get_ticket_row(session: AsyncSession) -> dict:
    result = await session.execute(
        select(Config.value).where(Config.guild_id == _DISCORD_GUILD_ID, Config.key == _TICKET_KEY)
    )
