...
from app.db.models import SurveyResponse, SurveyTemplate, Ticket, User, WebSurveySubmission
...
async def get_template_responses(
    ...
    if raw_visibility is None:
        ...
        if not (is_bypass or any(r in allowed_set for r in roles) or role_labels & allowed_set):
            raise HTTPException(403, "You do not have permission to view responses for this survey.")
