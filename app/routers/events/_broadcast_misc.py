...
async def handle_league_relic(
    ...
    await publish(
        valkey, "league_relic", dispatch_doc("league_relic", parsed.player_name, data)
    )
...
async def handle_league_rank(
    ...
    await publish(
        valkey, "league_rank", dispatch_doc("league_rank", parsed.player_name, data)
    )
...
async def handle_league_area(
    ...
    await publish(
        valkey, "league_area", dispatch_doc("league_area", parsed.player_name, data)
    )
...
async def handle_unknown(
    ...
    await publish(
        valkey,
        "unknown",
        dispatch_doc("unknown", None, {"raw_message": payload.message}),
    )
